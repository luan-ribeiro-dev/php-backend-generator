...
class Controle
{
	...
	public static function copyDaoDefaultClasses()
	{
		...
		$database = str_replace('$nomeBanco = ""', '$nomeBanco = "'.$config['database']['nome'].'"', $database);
		$database = str_replace('$caminho = ""', '$caminho = "'.$config['database']['caminho'].'"', $database);
		$database = str_replace('$login = ""', '$login = "'.$config['database']['login'].'"', $database);
		$database = str_replace('$senha = ""', '$senha = "'.$config['database']['senha'].'"', $database);
